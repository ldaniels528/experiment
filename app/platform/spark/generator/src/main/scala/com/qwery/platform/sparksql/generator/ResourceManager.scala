...
class ResourceManager {
  ...
  /**
    * Returns a table or view by name
    * @param name the given name of the table or view
    * @return the [[TableLike table or view]]
    */
  ...
  /**
    ...
    * @param columns the given [[Column columns]]
  ...
  /**
    ...
    * @param destination the destination [[TableLike table or view]]
