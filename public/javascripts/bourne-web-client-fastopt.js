...
$c_Lcom_github_ldaniels528_bourne_client_Filters$.prototype.toDuration__sjs_js_UndefOr__sjs_js_UndefOr = (function(aTime) {
  if ((aTime === (void 0))) {
    ...
    var age1 = 0.0;
    var unit = 0;
    while (((unit < this.timeFactors$1.length__I()) && (age0 >= $uI(this.timeFactors$1.apply__I__O(unit))))) {
      var timeFactor = $uI(this.timeFactors$1.apply__I__O(unit));
      var age = age0;
      age0 = (age / timeFactor);
      age1 = (age % timeFactor);
      unit = ((1 + unit) | 0)
    ...
    if ((age1 === 0.0)) {
      ...
      while ((i$2 < len$3)) {
        ...
        var elem$1 = $f_sci_StringLike__unwrapArg__psci_StringLike__O__O(this$20, arg1$1);
        array$3.push(elem$1);
        i$2 = ((1 + i$2) | 0)
      };
      $m_s_reflect_ManifestFactory$ObjectManifest$();
      ...
      var value = jsx$4.format__T__AO__T($$this$1, result$1)
    };
    return value
  }
});
$c_Lcom_github_ldaniels528_bourne_client_Filters$.prototype.init___ = (function() {
    ...
    return (function() {
      return (function($this$1) {
        return (function(time$2) {
          return $this$1.toDuration__sjs_js_UndefOr__sjs_js_UndefOr(time$2)
        })
      })($this)
    })
  })(this);
  this.bytes$1 = (function(this$2) {
    return (function() {
      return (function($this$2) {
        return (function(aValue$2) {
          if ((aValue$2 === (void 0))) {
            return (void 0)
          } else {
            var x$1 = $uD(aValue$2);
  ...
  this.bps$1 = (function(this$3$1) {
    return (function() {
      return (function($this$3) {
        return (function(aValue$2$1) {
          if ((aValue$2$1 === (void 0))) {
            return (void 0)
          } else {
...
$c_Lio_scalajs_npm_angularjs_AngularJsHelper$.prototype = new $h_O();
$c_Lio_scalajs_npm_angularjs_AngularJsHelper$.prototype.constructor = $c_Lio_scalajs_npm_angularjs_AngularJsHelper$;
/** @constructor */
function $h_Lio_scalajs_npm_angularjs_AngularJsHelper$() {
  /*<skip>*/
}
$h_Lio_scalajs_npm_angularjs_AngularJsHelper$.prototype = $c_Lio_scalajs_npm_angularjs_AngularJsHelper$.prototype;
$c_Lio_scalajs_npm_angularjs_AngularJsHelper$.prototype.init___ = (function() {
  this.io$scalajs$npm$angularjs$AngularJsHelper$$HttpError$1 = "Failed to process HTTP request:";
  return this
});
var $d_Lio_scalajs_npm_angularjs_AngularJsHelper$ = new $TypeData().initClass({
  Lio_scalajs_npm_angularjs_AngularJsHelper$: 0
}, false, "io.scalajs.npm.angularjs.AngularJsHelper$", {
  Lio_scalajs_npm_angularjs_AngularJsHelper$: 1,
  O: 1
});
$c_Lio_scalajs_npm_angularjs_AngularJsHelper$.prototype.$classData = $d_Lio_scalajs_npm_angularjs_AngularJsHelper$;
var $n_Lio_scalajs_npm_angularjs_AngularJsHelper$ = (void 0);
function $m_Lio_scalajs_npm_angularjs_AngularJsHelper$() {
  if ((!$n_Lio_scalajs_npm_angularjs_AngularJsHelper$)) {
    $n_Lio_scalajs_npm_angularjs_AngularJsHelper$ = new $c_Lio_scalajs_npm_angularjs_AngularJsHelper$().init___()
  };
  return $n_Lio_scalajs_npm_angularjs_AngularJsHelper$
}
/** @constructor */
function $c_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$() {
  $c_O.call(this)
}
$c_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$.prototype = new $h_O();
$c_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$.prototype.constructor = $c_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$;
/** @constructor */
function $h_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$() {
  /*<skip>*/
}
$h_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$.prototype = $c_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$.prototype;
$c_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$.prototype.init___ = (function() {
  return this
});
$c_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$.prototype.cleanUp$extension__jl_Throwable__T__T = (function($$this, s) {
  var this$2 = new $c_sci_StringOps().init___T(s);
  var x = $f_sci_StringLike__replaceAllLiterally__T__T__T(this$2, "\"", "");
  var this$4 = new $c_sci_StringOps().init___T(x);
  return $f_sci_StringLike__replaceAllLiterally__T__T__T(this$4, "'", "")
});
var $d_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$ = new $TypeData().initClass({
  Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$: 0
}, false, "io.scalajs.npm.angularjs.AngularJsHelper$ExceptionExtensions$", {
  Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$: 1,
  O: 1
});
$c_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$.prototype.$classData = $d_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$;
var $n_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$ = (void 0);
function $m_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$() {
  if ((!$n_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$)) {
    $n_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$ = new $c_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$().init___()
  };
  return $n_Lio_scalajs_npm_angularjs_AngularJsHelper$ExceptionExtensions$
}
/** @constructor */
function $c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$() {
  $c_O.call(this)
}
$c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$.prototype = new $h_O();
$c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$.prototype.constructor = $c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$;
/** @constructor */
function $h_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$() {
  /*<skip>*/
}
$h_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$.prototype = $c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$.prototype;
$c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$.prototype.init___ = (function() {
  return this
});
$c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$.prototype.$$lessinit$greater$default$4__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$.prototype.$$lessinit$greater$default$1__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$.prototype.$$lessinit$greater$default$5__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$.prototype.$$lessinit$greater$default$2__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$.prototype.$$lessinit$greater$default$6__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$.prototype.$$lessinit$greater$default$3__sjs_js_UndefOr = (function() {
  return (void 0)
});
var $d_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$ = new $TypeData().initClass({
  Lio_scalajs_npm_angularjs_toaster_ToasterOptions$: 0
}, false, "io.scalajs.npm.angularjs.toaster.ToasterOptions$", {
  Lio_scalajs_npm_angularjs_toaster_ToasterOptions$: 1,
  O: 1
});
$c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$.prototype.$classData = $d_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$;
var $n_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$ = (void 0);
function $m_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$() {
  if ((!$n_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$)) {
    $n_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$ = new $c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$().init___()
  };
  return $n_Lio_scalajs_npm_angularjs_toaster_ToasterOptions$
}
/** @constructor */
function $c_Lio_scalajs_npm_angularjs_toaster_package$() {
  $c_O.call(this);
  this.INFO$1 = null;
  this.DANGER$1 = null;
  this.ERROR$1 = null;
...
$c_Lio_scalajs_npm_angularjs_toaster_package$.prototype = new $h_O();
$c_Lio_scalajs_npm_angularjs_toaster_package$.prototype.constructor = $c_Lio_scalajs_npm_angularjs_toaster_package$;
/** @constructor */
function $h_Lio_scalajs_npm_angularjs_toaster_package$() {
  /*<skip>*/
}
$h_Lio_scalajs_npm_angularjs_toaster_package$.prototype = $c_Lio_scalajs_npm_angularjs_toaster_package$.prototype;
$c_Lio_scalajs_npm_angularjs_toaster_package$.prototype.init___ = (function() {
  this.INFO$1 = "info";
  this.DANGER$1 = "danger";
  this.ERROR$1 = "error";
  this.SUCCESS$1 = "success";
  this.WARNING$1 = "warning";
  return this
});
var $d_Lio_scalajs_npm_angularjs_toaster_package$ = new $TypeData().initClass({
  Lio_scalajs_npm_angularjs_toaster_package$: 0
}, false, "io.scalajs.npm.angularjs.toaster.package$", {
  Lio_scalajs_npm_angularjs_toaster_package$: 1,
  O: 1
});
$c_Lio_scalajs_npm_angularjs_toaster_package$.prototype.$classData = $d_Lio_scalajs_npm_angularjs_toaster_package$;
var $n_Lio_scalajs_npm_angularjs_toaster_package$ = (void 0);
function $m_Lio_scalajs_npm_angularjs_toaster_package$() {
  if ((!$n_Lio_scalajs_npm_angularjs_toaster_package$)) {
    $n_Lio_scalajs_npm_angularjs_toaster_package$ = new $c_Lio_scalajs_npm_angularjs_toaster_package$().init___()
  };
...
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype = new $h_O();
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype.constructor = $c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$;
/** @constructor */
function $h_Lio_scalajs_npm_angularjs_uirouter_RouteTo$() {
  /*<skip>*/
}
$h_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype = $c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype;
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype.$$lessinit$greater$default$10__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype.$$lessinit$greater$default$7__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype.init___ = (function() {
  return this
});
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype.$$lessinit$greater$default$11__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype.$$lessinit$greater$default$1__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype.$$lessinit$greater$default$4__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype.$$lessinit$greater$default$5__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype.$$lessinit$greater$default$8__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype.$$lessinit$greater$default$2__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype.$$lessinit$greater$default$3__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype.$$lessinit$greater$default$9__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype.$$lessinit$greater$default$6__sjs_js_UndefOr = (function() {
  return (void 0)
});
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype.$$lessinit$greater$default$12__sjs_js_UndefOr = (function() {
  return (void 0)
});
var $d_Lio_scalajs_npm_angularjs_uirouter_RouteTo$ = new $TypeData().initClass({
  Lio_scalajs_npm_angularjs_uirouter_RouteTo$: 0
}, false, "io.scalajs.npm.angularjs.uirouter.RouteTo$", {
  Lio_scalajs_npm_angularjs_uirouter_RouteTo$: 1,
  O: 1
});
$c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$.prototype.$classData = $d_Lio_scalajs_npm_angularjs_uirouter_RouteTo$;
var $n_Lio_scalajs_npm_angularjs_uirouter_RouteTo$ = (void 0);
function $m_Lio_scalajs_npm_angularjs_uirouter_RouteTo$() {
  if ((!$n_Lio_scalajs_npm_angularjs_uirouter_RouteTo$)) {
    $n_Lio_scalajs_npm_angularjs_uirouter_RouteTo$ = new $c_Lio_scalajs_npm_angularjs_uirouter_RouteTo$().init___()
  };
  return $n_Lio_scalajs_npm_angularjs_uirouter_RouteTo$
}
/** @constructor */
function $c_Lio_scalajs_util_DurationHelper$() {
  $c_O.call(this)
}
$c_Lio_scalajs_util_DurationHelper$.prototype = new $h_O();
$c_Lio_scalajs_util_DurationHelper$.prototype.constructor = $c_Lio_scalajs_util_DurationHelper$;
/** @constructor */
function $h_Lio_scalajs_util_DurationHelper$() {
  /*<skip>*/
}
$h_Lio_scalajs_util_DurationHelper$.prototype = $c_Lio_scalajs_util_DurationHelper$.prototype;
$c_Lio_scalajs_util_DurationHelper$.prototype.init___ = (function() {
  return this
});
$c_Lio_scalajs_util_DurationHelper$.prototype.duration2Int__s_concurrent_duration_Duration__I = (function(duration) {
  var t = duration.toMillis__J();
  var lo = t.lo$2;
  return lo
});
var $d_Lio_scalajs_util_DurationHelper$ = new $TypeData().initClass({
  Lio_scalajs_util_DurationHelper$: 0
}, false, "io.scalajs.util.DurationHelper$", {
  Lio_scalajs_util_DurationHelper$: 1,
  O: 1
});
$c_Lio_scalajs_util_DurationHelper$.prototype.$classData = $d_Lio_scalajs_util_DurationHelper$;
var $n_Lio_scalajs_util_DurationHelper$ = (void 0);
function $m_Lio_scalajs_util_DurationHelper$() {
  if ((!$n_Lio_scalajs_util_DurationHelper$)) {
    $n_Lio_scalajs_util_DurationHelper$ = new $c_Lio_scalajs_util_DurationHelper$().init___()
  };
  return $n_Lio_scalajs_util_DurationHelper$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
$c_ju_regex_Matcher$.prototype.quoteReplacement__T__T = (function(s) {
  var result = "";
  var i = 0;
  while ((i < $uI(s.length))) {
    var index = i;
...
$c_Lcom_github_ldaniels528_bourne_client_controllers_WorkflowController.prototype.updateWorkflow__p1__sjs_js_Array__Lcom_github_ldaniels528_bourne_client_models_Workflow__V = (function(workflows, workflow) {
  ...
  while (true) {
    if ((i < len)) {
      var index = i;
      var arg1 = workflows[index];
      var jsx$1 = (!$m_sr_BoxesRunTime$().equals__O__O__Z(arg1._id, workflow._id))
    } else {
      var jsx$1 = false
    };
    if (jsx$1) {
  ...
  var n = i;
  var x1 = ((n >= $uI(workflows.length)) ? (-1) : n);
  switch (x1) {
    case (-1): {
...
$c_Lcom_github_ldaniels528_bourne_client_services_WebSocketService.prototype.init__V = (function() {
  ...
  var value$1 = $g.window.WebSocket;
  ...
  if ($is_s_Some(x1)) {
    ...
    var x = $m_s_None$();
    if ((x === x1)) {
      this.toaster$1.pop("Info", "Your browser does not support Web Sockets.")
    } else {
      throw new $c_s_MatchError().init___O(x1)
    }
  }
...
$c_Lcom_github_ldaniels528_bourne_client_services_WebSocketService.prototype.connect__p1__V = (function() {
  ...
  this.socket$1.onmessage = (function(arg$outer$3) {
    return (function(arg1$2$3) {
      arg$outer$3.handleMessage__p1__Lio_scalajs_dom_ws_MessageEvent__V(arg1$2$3)
    })
  })(this);
  var jsx$3 = this.$$timeout$1;
  var jsx$2 = $m_Lio_scalajs_util_DurationHelper$();
  var this$7 = new $c_s_concurrent_duration_package$DurationInt().init___I(5);
  var unit = $m_ju_concurrent_TimeUnit$().SECONDS$1;
  jsx$3((function($this) {
    return (function() {
      $this.socket$1.send("Hello")
    })
...
$c_Lcom_github_ldaniels528_bourne_client_services_WebSocketService.prototype.handleMessage__p1__Lio_scalajs_dom_ws_MessageEvent__V = (function(event) {
  ...
  matchEnd6$2: {
    if ($is_s_Some(x1)) {
      var x2 = $as_s_Some(x1);
      var rawMessage = $as_T(x2.value$2);
      if ((rawMessage !== null)) {
        var message = $g.JSON.parse(rawMessage);
        var value = message.action;
        var this$6 = ((value === (void 0)) ? $m_s_None$() : new $c_s_Some().init___O(value));
        if (this$6.isEmpty__Z()) {
          var result = $m_s_None$()
        } else {
          var arg1 = this$6.get__O();
          var action = $as_T(arg1);
          ...
          if (this$12.isEmpty__Z()) {
            ...
            var x$1 = $as_T(arg1$1);
            var this$13 = new $c_s_Some().init___O($g.JSON.parse(x$1))
          };
          if (this$13.isEmpty__Z()) {
            var result = $m_s_None$()
          } else {
            var arg1$2 = this$13.get__O();
            var result = new $c_s_Some().init___O(new $c_T2().init___O__O(action, arg1$2))
          }
        };
        matchEnd6: {
          if ($is_s_Some(result)) {
            var x2$2 = $as_s_Some(result);
            var p3 = $as_T2(x2$2.value$2);
            if ((p3 !== null)) {
              var action$3 = $as_T(p3.$$und1$f);
              var data = p3.$$und2$f;
              this.$$rootScope$1.$broadcast(action$3, data);
              break matchEnd6
            }
          };
          var x = $m_s_None$();
          if ((x === result)) {
            var jsx$1 = $g.console;
            var s = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["Message does not contain either an 'action' or 'data' property: ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_T($g.angular.toJson(message))]));
            jsx$1.warn(s);
            break matchEnd6
          };
    ...
    if ((x$4 === x1)) {
      var jsx$2 = $g.console;
      var s$1 = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["Unhandled event received: ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_T($g.angular.toJson(event))]));
      jsx$2.warn(s$1);
      break matchEnd6$2
    };
    throw new $c_s_MatchError().init___O(x1)
...
function $a_Lcom_github_ldaniels528_bourne_client_controllers_AppTab() {
  if ((!$b_Lcom_github_ldaniels528_bourne_client_controllers_AppTab)) {
    ...
    var $c_Lcom_github_ldaniels528_bourne_client_controllers_AppTab = (function $c_Lcom_github_ldaniels528_bourne_client_controllers_AppTab(arg$1, arg$2, arg$3) {
      ...
      $g.Object.defineProperty(this, "uri", {
        "configurable": true,
        "enumerable": true,
        "writable": true,
        "value": null
...
function $a_Lio_scalajs_npm_angularjs_toaster_ToasterOptions() {
  if ((!$b_Lio_scalajs_npm_angularjs_toaster_ToasterOptions)) {
    /** @constructor */
    var $c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions = (function $c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions() {
      ...
      $g.Object.defineProperty(this, "body", {
        "configurable": true,
        "enumerable": true,
        "writable": true,
        "value": null
      });
      $g.Object.defineProperty(this, "timeout", {
        "configurable": true,
        "enumerable": true,
        "writable": true,
        "value": null
      });
      $g.Object.defineProperty(this, "showCloseButton", {
        "configurable": true,
        "enumerable": true,
        "writable": true,
        "value": null
      });
      $g.Object.defineProperty(this, "closeHtml", {
        "configurable": true,
        "enumerable": true,
        "writable": true,
        "value": null
    ...
    /** @constructor */
    var $h_Lio_scalajs_npm_angularjs_toaster_ToasterOptions = (function $h_Lio_scalajs_npm_angularjs_toaster_ToasterOptions() {
      /*<skip>*/
    });
    $h_Lio_scalajs_npm_angularjs_toaster_ToasterOptions.prototype = $g.Object.prototype;
    $c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions.prototype = new $h_Lio_scalajs_npm_angularjs_toaster_ToasterOptions();
    $c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions.prototype.constructor = $c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions;
    $b_Lio_scalajs_npm_angularjs_toaster_ToasterOptions = $c_Lio_scalajs_npm_angularjs_toaster_ToasterOptions
  };
  return $b_Lio_scalajs_npm_angularjs_toaster_ToasterOptions
}
var $b_Lio_scalajs_npm_angularjs_uirouter_RouteTo = (void 0);
function $a_Lio_scalajs_npm_angularjs_uirouter_RouteTo() {
  if ((!$b_Lio_scalajs_npm_angularjs_uirouter_RouteTo)) {
    /** @constructor */
    var $c_Lio_scalajs_npm_angularjs_uirouter_RouteTo = (function $c_Lio_scalajs_npm_angularjs_uirouter_RouteTo() {
      ...
      $g.Object.defineProperty(this, "controllerFn", {
        "configurable": true,
        "enumerable": true,
        "writable": true,
        "value": null
      });
      $g.Object.defineProperty(this, "controllerAs", {
        "configurable": true,
        "enumerable": true,
        "writable": true,
        "value": null
      ...
      $g.Object.defineProperty(this, "templateFn", {
        "configurable": true,
        "enumerable": true,
        "writable": true,
        "value": null
      });
      $g.Object.defineProperty(this, "templateUrl", {
        "configurable": true,
        "enumerable": true,
        "writable": true,
        "value": null
      });
      $g.Object.defineProperty(this, "templateUrlFn", {
        "configurable": true,
        "enumerable": true,
        "writable": true,
        "value": null
      });
      $g.Object.defineProperty(this, "resolve", {
        "configurable": true,
        "enumerable": true,
        "writable": true,
        "value": null
      });
      $g.Object.defineProperty(this, "redirectTo", {
        "configurable": true,
        "enumerable": true,
        "writable": true,
        "value": null
      });
      $g.Object.defineProperty(this, "redirectToFn", {
        "configurable": true,
        "enumerable": true,
        "writable": true,
        "value": null
      });
      $g.Object.defineProperty(this, "reloadOnSearch", {
        "configurable": true,
        "enumerable": true,
        "writable": true,
        "value": null
      });
      $g.Object.defineProperty(this, "caseInsensitiveMatch", {
        "configurable": true,
        "enumerable": true,
        "writable": true,
        "value": null
      ...
      this.templateUrlFn = templateUrlFn;
      this.resolve = resolve;
      this.redirectTo = redirectTo;
      this.redirectToFn = redirectToFn;
      this.reloadOnSearch = reloadOnSearch;
      this.caseInsensitiveMatch = caseInsensitiveMatch
    });
    /** @constructor */
    var $h_Lio_scalajs_npm_angularjs_uirouter_RouteTo = (function $h_Lio_scalajs_npm_angularjs_uirouter_RouteTo() {
      /*<skip>*/
    });
    ...
    $c_Lio_scalajs_npm_angularjs_uirouter_RouteTo.prototype.constructor = $c_Lio_scalajs_npm_angularjs_uirouter_RouteTo;
    $b_Lio_scalajs_npm_angularjs_uirouter_RouteTo = $c_Lio_scalajs_npm_angularjs_uirouter_RouteTo
  };
  return $b_Lio_scalajs_npm_angularjs_uirouter_RouteTo
}
/** @constructor */
...
$c_ju_concurrent_TimeUnit$.prototype.java$util$concurrent$TimeUnit$$x__J__J__J__J = (function(a, b, max) {
  ...
  if (((ahi === bhi) ? (((-2147483648) ^ a.lo$2) > ((-2147483648) ^ max.lo$2)) : (ahi > bhi))) {
    ...
    if (((ahi$1 === hi$1) ? (((-2147483648) ^ a.lo$2) < ((-2147483648) ^ lo$1)) : (ahi$1 < hi$1))) {
      ...
      var hi$2 = (((((((($imul(alo, b.hi$2) + $imul(a.hi$2, blo)) | 0) + $imul(a1, b1)) | 0) + ((c1part >>> 16) | 0)) | 0) + (((((65535 & c1part) + a1b0) | 0) >>> 16) | 0)) | 0);
...
$c_jl_StringBuffer.prototype.append__jl_CharSequence__jl_Appendable = (function(csq) {
  return this.append__O__jl_StringBuffer(csq)
});
$c_jl_StringBuffer.prototype.append__O__jl_StringBuffer = (function(obj) {
  return ((obj === null) ? this.append__T__jl_StringBuffer(null) : this.append__T__jl_StringBuffer($objectToString(obj)))
});
$c_jl_StringBuffer.prototype.append__T__jl_StringBuffer = (function(s) {
  this.content$1 = (("" + this.content$1) + ((s === null) ? "null" : s));
  return this
});
$c_jl_StringBuffer.prototype.append__C__jl_Appendable = (function(c) {
  return this.append__C__jl_StringBuffer(c)
});
...
function $f_sci_StringLike__replaceAllLiterally__T__T__T($thiz, literal, replacement) {
  var arg1 = $m_ju_regex_Pattern$().quote__T__T(literal);
  var arg2 = $m_ju_regex_Matcher$().quoteReplacement__T__T(replacement);
  return $m_sjsr_RuntimeString$().replaceAll__T__T__T__T($thiz.toString__T(), arg1, arg2)
}
/** @constructor */
